...
export function bindEvents() {
  ...
  scheduleInput.addEventListener("keypress", (e) => {
    if (e.key === "Enter") addScheduleButton.click();
  });

  todoList.addEventListener("click", (e) => handleRemove(e, "todo", todoList));
  scheduleList.addEventListener("click", (e) => handleRemove(e, "schedule", scheduleList));

  todoList.addEventListener("change", (e) => handleCheckbox(e, "todo"));
  scheduleList.addEventListener("change", (e) => handleCheckbox(e, "schedule"));
}

function handleRemove(e, type, listEl) {
...
function handleCheckbox(e, type) {
